...
function App() {
  ...
  const logout = async () => {
    try {
      const answer = await axios.get(baseUrl + "/auth/logout", {
        headers: {
          "Content-Type": "application/json",
          "Access-Control-Allow-Credentials": true,
        },
          ...
          <Link to="/Cart">
            <h4>
              <i className="bi bi-cart4">
                <span
                  style={{ fontSize: 10 }}
                  className="position-absolute top-20 start-90 translate-middle badge rounded-pill bg-secondary"
                >
                  {commandes.length}
                </span>
              </i>
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  >
                    ...
                    <div
                      value={inPassword}
                      onChange={(e) => setInPasswor(e.target.value)}
                      className="input-group mb-3 mt-3"
                    >
                      <span
                        className="input-group-text bi bi-lock"
                        id="basic-addon1"
                      ></span>
                      <input
                        type="password"
                ...
                >
                  ...
                  >
                    ...
                    <div
                      value={upPassword}
                      onChange={(e) => setUpPasswor(e.target.value)}
                      className="input-group mb-3 mt-3"
                    >
                      <span
                        className="input-group-text bi bi-lock"
